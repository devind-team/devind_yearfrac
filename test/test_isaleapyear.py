...
class TestIsaLeapYear(unittest.TestCase):
    def test1(self):
        lyrs = [
            ...
            2392, 2396, 2400]
        x = [isaleapyear(y) for y in lyrs]
        t = [True for _ in lyrs]
        self.assertListEqual(x, t)

    def test2(self):
        self.assertEqual(isaleapyear(2017), False)

    def test3(self):
        self.assertEqual(isaleapyear(2018), False)

    def test4(self):
        self.assertEqual(isaleapyear(2019), False)
